...
import { initMonaco } from "./monaco-setup.js?v=20260726T121621Z";
import { runYamlDoctor } from "./yaml-doctor.js?v=20260726T121621Z";
import {
  applyTeachingMarkers,
  clearTeachingMarkers,
} from "./teaching-markers.js?v=20260726T121621Z";
import { detectTeachingIssues } from "./teaching-rules.js?v=20260726T121621Z";
import { renderMarkdown } from "./yaml-utils.js?v=20260726T121621Z";
import { lessonPacks } from "./lessons.js?v=20260726T121621Z";
import { scrollToRefInEditor } from "./refs.js?v=20260726T121621Z";
import { getYamlHierarchy } from "./yaml-utils.js?v=20260726T121621Z";
